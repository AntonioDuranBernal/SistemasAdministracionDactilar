                    ...
                    <tbody>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap dark:text-white">
                         ...
                         <td class="px-6 py-4 whitespace-nowrap dark:text-white">
                            ...
                            <a href="{{ route('cliente.asignadosBasico', ['id_cliente' => $elemento->id_cliente, 'id_usuario' => $usuario->idUsuarioSistema]) }}">Asignados</a>

                                @if(collect($permisosUsuario)->where('indice', 'registrarExpediente')->first()['valor'] == 1)
