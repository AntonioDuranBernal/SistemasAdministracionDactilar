...
<form action="{{ route('ejecutarExpedienteDocumentoSU') }}" method="POST" class="mb-4">
    @csrf
    ...
    <div class="w-1/3">
        ...
        <input type="text" id="id_expediente" name="id_expediente" placeholder="Número de Expediente" class="w-full p-2 border border-gray-300 rounded">
    </div>
</div>
