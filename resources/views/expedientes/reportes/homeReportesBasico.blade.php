...
<div class="col-span-10 h-[100px] p-3"> <!-- Quita la clase bg-gray-200 y aplica una altura fija -->
    <br>
    <h1 class="text-2xl font-bold mb-4 text-center">REPORTE GENERAL</h1>
    </div>
</div>
...
<form action="{{ route('ejecutarExpedienteGeneralSU') }}" method="POST" class="mb-4">
  ...
  <input type="date" id="fecha_inicio" name="fecha_inicio" value="2023-09-25" class="w-full p-2 border border-gray-300 rounded">
</div>
            <div class="w-1/2">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="fecha_fin">
    Fecha Fin:
  </label>
  <input type="date" id="fecha_fin" name="fecha_fin" value="2023-09-26" class="w-full p-2 border border-gray-300 rounded">
 </div>
        </div>
